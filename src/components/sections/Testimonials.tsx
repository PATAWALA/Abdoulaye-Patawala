...
const Testimonials: React.FC = () => {
  ...
  return (
    <section id="testimonials" className="bg-dark-800 overflow-hidden">
      <div className="py-20 lg:py-28 px-4 md:px-8 max-w-7xl mx-auto">
        ...
        {testimonials.length === 0 ? (
          <div className="text-center py-12 motion-safe:animate-fade-in">
            ...
            <p className="text-gray-400 text-lg mb-2">Aucun témoignage pour le moment.</p>
          ...
          <>
            ...
            <div className="mt-16 lg:mt-20 flex flex-wrap items-center justify-center gap-8 lg:gap-12 motion-safe:animate-fade-in">
              ...
              <div className="text-center">
                ...
                <p className="text-gray-500 text-sm mt-1">De satisfaction</p>
              </div>
              <div className="w-px h-10 bg-dark-700 hidden sm:block" />
              <div className="text-center">
