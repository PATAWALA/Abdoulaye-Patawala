  ...
  <section className="bg-dark-800 dark:bg-dark-800 light:bg-white">
    <div className="py-20 lg:py-28 px-4 md:px-8 max-w-7xl mx-auto">
      ...
      <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8 mb-12">
        {[1, 2, 3].map((i) => (
          <div key={i} className="bg-dark-700 border border-dark-600 dark:bg-dark-700 dark:border-dark-600 light:bg-gray-50 light:border-gray-200 rounded-2xl overflow-hidden">
            <div className="aspect-video bg-dark-600 dark:bg-dark-600 light:bg-gray-200 animate-pulse" />
            <div className="p-6 space-y-3">
              <div className="h-3 w-20 bg-dark-600 dark:bg-dark-600 light:bg-gray-200 rounded-full animate-pulse" />
              ...
              <div className="h-4 w-2/3 bg-dark-600 dark:bg-dark-600 light:bg-gray-200 rounded animate-pulse" />
            </div>
          </div>
        ))}
      </div>
