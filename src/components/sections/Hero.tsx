...
const Hero: React.FC = () => {
  ...
  return (
    <section
      id="hero"
      className="min-h-screen flex flex-col justify-center pt-24 pb-12 px-4 md:px-16 relative"
    >
      {/* Fond noir sur toute la largeur */}
      <div className="absolute inset-0 bg-dark-900" />
      {/* Dégradé doré sur toute la largeur */}
      <div
        className="absolute top-0 left-0 w-full h-48 pointer-events-none"
        style={{
          background:
            'linear-gradient(to bottom, rgba(212,175,55,0.12) 0%, rgba(212,175,55,0.04) 50%, rgba(10,10,10,0) 100%)',
        }}
      />
        ...
        <div className="hidden lg:flex justify-center mb-12 motion-safe:animate-fade-in">
          <div className="inline-flex items-center gap-2 px-5 py-2.5 rounded-full border border-gold-500/20 bg-gold-500/5">
            ...
            <span className="text-sm text-gray-300">
              Ouvert aux projets · Coachs, Infopreneurs & Cabinets
            </span>
          </div>
        </div>
        ...
        <div className="grid lg:grid-cols-2 gap-10 lg:gap-20 items-center w-full">
          ...
          <div className="space-y-8 text-center lg:text-left motion-safe:animate-fade-in">
            ...
            <p className="text-lg md:text-xl text-gray-300 leading-relaxed">
              Je construis des systèmes de vente qui transforment votre expertise en revenus
              prévisibles.
            </p>
